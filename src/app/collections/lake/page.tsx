...
import { LAKE_COLLECTION, SHARED_PDFS } from "@/data/collections";

export const metadata: Metadata = {
  title: "Lake Collection — Luxury Homes on 150' Lots | Young's Cove",
  description:
    "Explore the Lake Collection at Young's Cove — luxury bungalow and bungalow loft residences on 150-foot homesites with stunning Lake Ontario views in Quinte West, Ontario.",
};

export default function LakeCollectionPage() {
  const collection = LAKE_COLLECTION;
          ...
          <div className="max-w-[1264px] mx-auto px-4 sm:px-6 lg:px-8">
            <FadeInUp>
              ...
              <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-normal text-foreground leading-[1.16] tracking-tight">
                {collection.models.length} Home Models
              </h2>
            </FadeInUp>
