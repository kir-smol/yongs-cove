...
const IMAGES_13EVT: PropertyImage[] = [
  ...
  // Great room & living
  { src: "/images/1-interior.jpg", alt: "Staged great room — double-height ceilings, fireplace, oak staircase", category: "interior" },
  { src: "/images/2-interior.jpg", alt: "Great room — open concept living area", category: "interior" },
  { src: "/images/3-interior.jpg", alt: "Great room — staircase and fireplace view", category: "interior" },
  { src: "/images/4-interior.jpg", alt: "Living area — natural light and hardwood floors", category: "interior" },
  { src: "/images/5-interior.jpg", alt: "Open concept — living to kitchen flow", category: "interior" },
  { src: "/images/6-interior.jpg", alt: "Living and dining area overview", category: "interior" },
  { src: "/images/7-interior.jpg", alt: "Interior detail — main floor", category: "interior" },
  // Kitchen & dining
  { src: "/images/8-interior-kitchen.jpg", alt: "Kitchen — dark cabinetry, quartz island with bar stools", category: "interior" },
  { src: "/images/9-interior-dining-area.jpg", alt: "Kitchen and dining — open concept", category: "interior" },
  { src: "/images/10-interior-dining-area.jpg", alt: "Dining area — elegant staging", category: "interior" },
  { src: "/images/11-interior-dining-area.jpg", alt: "Dining area — view towards kitchen", category: "interior" },
  { src: "/images/12-interior-dining-area.jpg", alt: "Dining and kitchen — sliding doors to backyard", category: "interior" },
  // Primary suite
...
const IMAGES_30WW: PropertyImage[] = [
  ...
  // Great room & living
  { src: "/30 Wellers Way Images/4-30-wellers-interior-1.jpg", alt: "Great room — double-height ceilings, loft, kitchen island", category: "interior" },
  { src: "/30 Wellers Way Images/5-30-wellers-interior-2.jpg", alt: "Great room — hardwood floors, expansive windows", category: "interior" },
  { src: "/30 Wellers Way Images/6-30-wellers-interior-3.jpg", alt: "Great room — loft balcony, kitchen, pendant lights", category: "interior" },
  { src: "/30 Wellers Way Images/7-30-wellers-interior-4.jpg", alt: "Living area — open concept to kitchen and loft", category: "interior" },
  { src: "/30 Wellers Way Images/8-30-wellers-interior-5.jpg", alt: "Living room — gas fireplace, vaulted ceiling", category: "interior" },
  { src: "/30 Wellers Way Images/9-30-wellers-interior-6.jpg", alt: "Great room — fireplace and large windows", category: "interior" },
  // Kitchen & dining
  { src: "/30 Wellers Way Images/10-30-wellers-interior-7.jpg", alt: "Kitchen — quartz island, pendant lights, stainless appliances", category: "interior" },
  { src: "/30 Wellers Way Images/11-30-wellers-interior-8.jpg", alt: "Kitchen — custom cabinetry, glass-front uppers", category: "interior" },
  { src: "/30 Wellers Way Images/12-30-wellers-interior-9.jpg", alt: "Kitchen — range hood, built-in cabinetry", category: "interior" },
  { src: "/30 Wellers Way Images/13-30-wellers-interior-10.jpg", alt: "Kitchen — island, open concept to living", category: "interior" },
  { src: "/30 Wellers Way Images/14-30-wellers-interior-11.jpg", alt: "Kitchen — countertops, glass-front display cabinets", category: "interior" },
  { src: "/30 Wellers Way Images/15-30-wellers-interior-12.jpg", alt: "Kitchen — island with bar stools, sliding doors to deck", category: "interior" },
  { src: "/30 Wellers Way Images/16-30-wellers-interior-13.jpg", alt: "Kitchen and eating area — pendant lights, hardwood", category: "interior" },
  { src: "/30 Wellers Way Images/17-30-wellers-interior-14.jpg", alt: "Kitchen — full island, tall cabinetry, open to living", category: "interior" },
...
const IMAGES_2BHD: PropertyImage[] = [
  ...
  { src: "/2 BLUE HERON DRIVE/2-2-Blue-Heron-Drive-interior.jpg", alt: "Great room — open concept, natural light", category: "interior" },
  { src: "/2 BLUE HERON DRIVE/3-2-Blue-Heron-Drive-interior.jpg", alt: "Office — staged workspace, natural light", category: "interior" },
  { src: "/2 BLUE HERON DRIVE/4-2-Blue-Heron-Drive-interior.jpg", alt: "Kitchen — island, pendant lights, hardwood", category: "interior" },
  { src: "/2 BLUE HERON DRIVE/5-2-Blue-Heron-Drive-interior.jpg", alt: "Kitchen — cabinetry, stainless appliances", category: "interior" },
  { src: "/2 BLUE HERON DRIVE/6-2-Blue-Heron-Drive-interior.jpg", alt: "Dining area — open concept to kitchen", category: "interior" },
  { src: "/2 BLUE HERON DRIVE/7-2-Blue-Heron-Drive-interior.jpg", alt: "Living room — fireplace, large windows", category: "interior" },
...
const IMAGES_18BHD: PropertyImage[] = [
  ...
  { src: "/18 BLUE HERON DRIVE/4-18-Blue-Heron-Drive-interior.jpg", alt: "Great room — fireplace, large windows", category: "interior" },
  { src: "/18 BLUE HERON DRIVE/5-18-Blue-Heron-Drive-interior.jpg", alt: "Great room — fireplace, natural light", category: "interior" },
  { src: "/18 BLUE HERON DRIVE/6-18-Blue-Heron-Drive-interior.jpg", alt: "Kitchen — island, cabinetry, open concept", category: "interior" },
...
const IMAGES_46EVT: PropertyImage[] = [
  ...
  { src: "/46 EAST VISTA TERRACE/2-east-vista-terrace-interior.jpg", alt: "Great room — open concept, hardwood floors", category: "interior" },
  { src: "/46 EAST VISTA TERRACE/3-east-vista-terrace-interior.jpg", alt: "Great room — 21-foot ceiling, fireplace, loft railing", category: "interior" },
  { src: "/46 EAST VISTA TERRACE/4-east-vista-terrace-interior.jpg", alt: "Kitchen — island, modern cabinetry", category: "interior" },
  { src: "/46 EAST VISTA TERRACE/5-east-vista-terrace-interior.jpg", alt: "Kitchen — stainless appliances, pendant lights", category: "interior" },
  { src: "/46 EAST VISTA TERRACE/6-east-vista-terrace-interior.jpg", alt: "Dining area — open to kitchen", category: "interior" },
...
const IMAGES_12LPD: PropertyImage[] = [
  ...
  { src: "/12 LARISSA PARK DRIVE/2-12-larissa-park-drive-interior.jpg", alt: "Great room — open concept, hardwood floors", category: "interior" },
  { src: "/12 LARISSA PARK DRIVE/3-12-larissa-park-drive-interior.jpg", alt: "Great room — fireplace, natural light", category: "interior" },
  { src: "/12 LARISSA PARK DRIVE/4-12-larissa-park-drive-interior.jpg", alt: "Kitchen — island, quartz countertops", category: "interior" },
  { src: "/12 LARISSA PARK DRIVE/5-12-larissa-park-drive-interior.jpg", alt: "Kitchen — cabinetry, stainless appliances", category: "interior" },
  { src: "/12 LARISSA PARK DRIVE/6-12-larissa-park-drive-interior.jpg", alt: "Dining area — open to kitchen", category: "interior" },
...
const IMAGES_3LPD: PropertyImage[] = [
  ...
  { src: "/3 LARISSA PARK DRIVE/2-3-larissa-park-drive-interior.jpg", alt: "Great room — open concept, hardwood", category: "interior" },
  { src: "/3 LARISSA PARK DRIVE/3-3-larissa-park-drive-interior.jpg", alt: "Kitchen — island, quartz countertops", category: "interior" },
  { src: "/3 LARISSA PARK DRIVE/4-3-larissa-park-drive-interior.jpg", alt: "Kitchen — cabinetry, stainless appliances", category: "interior" },
  { src: "/3 LARISSA PARK DRIVE/5-3-larissa-park-drive-interior.jpg", alt: "Eating area — open to kitchen", category: "interior" },
...
const IMAGES_42WW: PropertyImage[] = [
  ...
  { src: "/42 WELLERS WAY/3-42-wellers-way-interior.jpg", alt: "Great room — double-height ceiling, fireplace", category: "interior" },
  { src: "/42 WELLERS WAY/4-42-wellers-way-interior.jpg", alt: "Great room — open concept, hardwood", category: "interior" },
  { src: "/42 WELLERS WAY/5-42-wellers-way-interior.jpg", alt: "Living area — natural light, large windows", category: "interior" },
  { src: "/42 WELLERS WAY/6-42-wellers-way-interior.jpg", alt: "Kitchen — island, quartz countertops", category: "interior" },
  { src: "/42 WELLERS WAY/7-42-wellers-way-interior.jpg", alt: "Kitchen — cabinetry, stainless appliances", category: "interior" },
  { src: "/42 WELLERS WAY/8-42-wellers-way-interior.jpg", alt: "Dining area — open to kitchen", category: "interior" },
  ...
  { src: "/42 WELLERS WAY/16-42-wellers-way-interior.jpg", alt: "Interior — open concept overview", category: "interior" },
...
const IMAGES_53WW: PropertyImage[] = [
  ...
  { src: "/53 WELLERS WAY/3-53-wellers-way-interior.jpg", alt: "Great room — fireplace, natural light", category: "interior" },
  { src: "/53 WELLERS WAY/4-53-wellers-way-interior.jpg", alt: "Great room — open concept, hardwood", category: "interior" },
  { src: "/53 WELLERS WAY/5-53-wellers-way-interior.jpg", alt: "Kitchen — island, quartz countertops", category: "interior" },
  { src: "/53 WELLERS WAY/6-53-wellers-way-interior.jpg", alt: "Kitchen — cabinetry, stainless appliances", category: "interior" },
  { src: "/53 WELLERS WAY/7-53-wellers-way-interior.jpg", alt: "Eating area — open to kitchen", category: "interior" },
